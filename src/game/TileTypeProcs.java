...
public class TileTypeProcs {
	...
	Function<TileIndex,TileDesc> get_tile_desc_proc;
	...
	TileVehicleInterface vehicle_enter_tile_proc;
	TileVehicleInterface vehicle_leave_tile_proc;
	
	//abstract int get_slope_tileh_proc(final TileInfo ti);
	Function<TileInfo,Integer> get_slope_tileh_proc;
