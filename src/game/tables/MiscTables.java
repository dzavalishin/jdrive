...
public class MiscTables 
{
	...
	static int[] hw = { 1, 16, 4, 16, 3, 8, 16, 16, 0, 16, 8, 16 };	
	static int[] hspr = { 0x10C9, 0x10CA, 0x10CB, 0x10CC, 0x10CD, 0x10CE, 0x10CF, 0x10D0, 0x2, 0x10D9, 0x10D3, 0x10D8 };
	static int[] hicp = { 3185, 5916, 4550, 4437, 4322, 6144, 4778, 5005, 5120, 5461, 5802, 5688 };	
	static int[] htdt1 = { 0, 7, 20, 25, 4, 5, 4, 15, 9, 7, 10, 0, };
	static int[] htdt2 = { 24, 255, 90, 255, 18, 28, 40, 255, 255, 60, 40, 30 };
	static int[][] hrbc = {
			{27, 29, 28, 30, 31, 32, 33, 34, 35, 39, 37, 38},
			{57, 59, 58, 60, 61, 62, 63, 64, 65, 69, 67, 68},
			{89, 91, 90, 92, 93, 94, 95, 96, 97, 101, 99, 100}
	};
	static int[]hrvs = {116, 123, 126, 132, 135, 138, 141, 144, 147, 159, 153, 156};
	static int[]hrvc = 		{7, 3, 6, 3, 3, 3, 3, 3, 3, 3, 3, 3};
	...
	static int[] dw = {		1, 16, 4, 16, 16, 8, 16, 16, 16, 16, 2, 16,		};
	static int[] dspr = {			0x10C9, 0x10DA, 0x10CB, 0x10CC, 0x10D4, 0x10CE, 0x10CF, 0x10D0, 0x10D5, 0x10D6, 0x10D7, 0x10D8		};
	static int[] dicp = {			3185, 4437, 4550, 4892, 4209, 6144, 4322, 7964, 4892, 4664, 5802, 5688		};
	static int[] dtdt1 = {			0, 2, 20, 25, 0, 5, 4, 15, 12, 20, 10, 0		};
	static int[] dtdt2 = {			24, 20, 90, 255, 15, 28, 40, 255, 255, 80, 255, 30		};
	static int[][] drbc = {
	...
	static int[] drvcs = {116, 171, 126, 132, 168, 138, 141, 144, 162, 165, 153, 156};
	static int[] drvcc = {7, 3, 6, 3, 3, 3, 3, 3, 3, 3, 3, 3};
	...
	static int[] cw = {			1, 16, 4, 2, 4, 5, 16, 16, 16, 1, 16, 2		};
	static int[] cspr = {			0x10C9, 0x10DC, 0x10CB, 0x10DD, 0x10E3, 0x10DB, 0x10E0, 0x10D6, 0x10DE, 0x10E1, 0x10E2, 0x10DF		};
	static int[] cicp = { 		3185, 4437, 4550, 5574, 4322, 6144, 4778, 4892, 5005, 5077, 4664, 6250 		};	
	static int[] ctdt1 = {			0, 20, 20, 25, 2, 8, 14, 5, 10, 20, 30, 30,		};
	static int[] ctdt2 = {			24, 255, 90, 255, 30, 40, 60, 75, 25, 80, 255, 50		};
	static int[][] crbc = {
	...
	static int[] crvcs = {116, 174, 126, 186, 192, 189, 183, 177, 180, 201, 198, 195};
	static int[] crvcc = {7, 3, 6, 3, 3, 3, 3, 3, 3, 3, 3, 3};
