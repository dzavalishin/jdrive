...
public class Patches
{
	...
	public boolean inflation = true;					// disable inflation
	...
	public boolean gotodepot = true;					// allow goto depot in orders
	public boolean build_rawmaterial_ind = true;	 // allow building raw material industries
	...
	public boolean show_finances;			// show finances at end of year
	...
	public boolean ai_disable_veh_train;		// disable types for AI
	public boolean ai_disable_veh_roadveh;		// disable types for AI
	public boolean ai_disable_veh_aircraft;		// disable types for AI
	...
	public boolean serviceathelipad = true;	// service helicopters at helipads automatically (no need to send to depot)
	public boolean smooth_economy = true;		// smooth economy
