...
{
	RailType railtype;
	EngineID selected_id[] = { INVALID_ENGINE, INVALID_ENGINE };
	int [] sel = new int[2];
	int count = 0;
	int count2 = 0;
	EngineID engine_id;
...
/************ Sorter functions *****************/
class GeneralOwnerSorter implements Comparator<SortStruct>
{
 ...
 */
class VehicleUnsortedSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
...
class VehicleNumberSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
		final Vehicle va = GetVehicle(a.index);
		final Vehicle vb = GetVehicle(b.index);
...
class VehicleNameSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
...
class VehicleAgeSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
		final Vehicle va = GetVehicle(a.index);
...
class VehicleProfitThisYearSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
		final Vehicle va = GetVehicle(a.index);
...
class VehicleProfitLastYearSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
		final Vehicle va = GetVehicle(a.index);
...
class VehicleCargoSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
		final Vehicle  va = GetVehicle(a.index);
...
class VehicleReliabilitySorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
		final Vehicle va = GetVehicle(a.index);
...
class VehicleMaxSpeedSorter implements Comparator<SortStruct>
{
	public int compare (SortStruct a, SortStruct b)
	{
		final Vehicle va = GetVehicle(a.index);
