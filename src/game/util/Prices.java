...
public class Prices {
	...
	public void setPrice(int i, int price)
	{
		switch(i)
		{
		case 0: station_value = price;
		case 1: build_rail = price;
		case 2: build_road = price;
		case 3: build_signals = price;
		case 4: build_bridge = price;
		case 5: build_train_depot = price;
		case 6: build_road_depot = price;
		case 7: build_ship_depot = price;
		case 8: build_tunnel = price;
		case 9: train_station_track = price;
		case 10: train_station_length = price;
		case 11: build_airport = price;
		case 12: build_bus_station = price;
		case 13: build_truck_station = price;
		case 14: build_dock = price;
		case 15: build_railvehicle = price;
		case 16: build_railwagon = price;
		case 17: aircraft_base = price;
		case 18: roadveh_base = price;
		case 19: ship_base = price;
		case 20: build_trees = price;
		case 21: terraform = price;
		case 22: clear_1 = price;
		case 23: purchase_land = price;
		case 24: clear_2 = price;
		case 25: clear_3 = price;
		case 26: remove_trees = price;
		case 27: remove_rail = price;
		case 28: remove_signals = price;
		case 29: clear_bridge = price;
		case 30: remove_train_depot = price;
		case 31: remove_road_depot = price;
		case 32: remove_ship_depot = price;
		case 33: clear_tunnel = price;
		case 34: clear_water = price;
		case 35: remove_rail_station = price;
		case 36: remove_airport = price;
		case 37: remove_bus_station = price;
		case 38: remove_truck_station = price;
		case 39: remove_dock = price;
		case 40: remove_house = price;
		case 41: remove_road = price;
		case 42: running_rail[0] = price;
		case 43: running_rail[1] = price;
		case 44: running_rail[2] = price;
		case 45: aircraft_running = price;
		case 46: roadveh_running = price;
		case 47: ship_running = price;
		case 48: build_industry = price;
