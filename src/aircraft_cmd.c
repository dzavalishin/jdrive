/* $Id: aircraft_cmd.c 3352 2005-12-28 22:29:59Z peter1138 $ */
...
int32 CmdStartStopAircraft(int x, int y, uint32 flags, uint32 p1, uint32 p2)
{
	...
	if (_patches.allow_municipal_airports && MA_VehicleIsAtMunicipalAirport(v) && !(v->vehstatus & VS_STOPPED)) return_cmd_error(STR_MA_CANT_STOP_AT_MUNICIPAL);
