public class SignStruct
{
    ...
    private static MemoryPool<SignStruct> _sign_pool = new MemoryPool();
...
static  bool IsSignIndex(int index)
{
 ...
 *
 */
static void CcPlaceSign(bool success, TileIndex tile, int p1, int p2)
{
	if (success) {
