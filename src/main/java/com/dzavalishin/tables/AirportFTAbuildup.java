...
/*	
	static final TileIndexDiffC _airport_depots_country[] = {
			new TileIndexDiffC(3, 0)};

	static final byte _airport_terminal_country[] = {1, 2};
	static final AirportFTAbuildup _airport_fta_country[] = {
	...
	static final TileIndexDiffC _airport_depots_city[] = {
			new TileIndexDiffC(5, 0)};
	static final byte _airport_terminal_city[] = {1, 3};
	static final AirportFTAbuildup _airport_fta_city[] = {
	...
	static final TileIndexDiffC _airport_depots_metropolitan[] = {
			new TileIndexDiffC(5, 0)};
	static final byte _airport_terminal_metropolitan[] = {1, 3};
	static final AirportFTAbuildup _airport_fta_metropolitan[] = {
			new AirportFTAbuildup(  0,HANGAR,NOTHING_block,1),
			new AirportFTAbuildup(  1,255,TAXIWAY_BUSY_block,0), new AirportFTAbuildup( 1,HANGAR,0,0), new AirportFTAbuildup( 1,TERM2,0,6), new AirportFTAbuildup( 1,TERM3,0,6), new AirportFTAbuildup( 1,0,0,7), // for all else, go to 7
	...
	static final TileIndexDiffC _airport_depots_international[] = {
			new TileIndexDiffC(0, 3), new TileIndexDiffC(6, 1)};
	static final byte _airport_terminal_international[] = {2, 3, 3};
	static final byte _airport_helipad_international[] = {1, 2};
	static final AirportFTAbuildup _airport_fta_international[] = {
	...
	static final byte _airport_helipad_heliport_oilrig[] = {1, 1};
	static final AirportFTAbuildup _airport_fta_heliport_oilrig[] = {
